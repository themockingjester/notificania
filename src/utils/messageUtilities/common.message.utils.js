const prepareProperObjectOutOfNotificationEventConfigDetailsForAMessage = (notificationEventConfig = []) => {
    let finalResult = {}
...
module.exports = {
    prepareProperObjectOutOfNotificationEventConfigDetailsForAMessage, isMessageEventConfigHaveNeededKeys
}